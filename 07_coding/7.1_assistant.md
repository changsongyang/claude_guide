...
相比其他 AI，Claude 在编程领域有着独特的优势：**超长上下文窗口（Opus 4.6+ 支持 1M Token）** 和 **卓越的推理能力 (Opus/Sonnet)**，这使它成为处理大规模重构和复杂架构设计的理想伙伴。
...
| **Context** | 主要是当前文件 + 最近打开的文件。 | 可以一次性吃掉整个仓库的核心代码（Opus 4.6+ 支持 1M tokens）。 |
