...
近期 Claude Sonnet 5、Claude Opus 4.8/4.7/4.6，以及作为兼容性基线的 Claude Sonnet 4.6 和 Claude Opus 4.5，其 Computer Use 组合通常是 `computer-use-2025-11-24` / `computer_20251124`，并配合 `text_editor_20250728` 与 `bash_20250124`；Claude Sonnet 4.5 / Haiku 4.5（以及已弃用的 Opus 4.1、Sonnet 4、Opus 4）目前仍需使用 `computer-use-2025-01-24` / `computer_20250124`，并非过时组合（更早的 Claude 3.7 文档亦用此组合）。版本会随模型更新，不能写死成永久规则。
